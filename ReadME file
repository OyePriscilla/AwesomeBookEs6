...
This Project is created purposely to dynamically add and remove books from the User Interface and the local storage. It is one of the mandatory projects for every student in Microverse. ES6 was used to write the code in JavaScript Modules.
